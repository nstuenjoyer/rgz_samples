    ...
    return (
        <Col md={4} className='mt-4' >
            <Card className='p-2' style={{ height: "100%" }}  >
                ...
                <Form className='d-flex flex-row justify-content-between'><Button type="button" className="btn btn-primary btn-sm align-self-center mt-auto" href={'http://217.71.129.139:4560/' + props.docx_sample}>Скачать шаблон</Button>
                    {
                        user.isAuth ?
