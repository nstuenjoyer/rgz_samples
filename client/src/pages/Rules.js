...
const Rules = () => {
    return (
        <Container className="pb-4 pt-4">
            <Col md={11}>
                <div className="text-box" style={{ color: "black" }}>
                    <p>
                    </p>
                    ...
                    <h2 className="asd">Cуперкраткий шаблон оформления отчетов по учебной работе:
                        <a href='http://217.71.129.139:4560/download.docx'>Cкачать</a>.
                    </h2>
                    ...
                    <img src="http://217.71.129.139:4560/titlePage.png" alt="пример титульного листа курсовой" width="70%" />
                    ...
                    <img src="http://217.71.129.139:4560/contents.png" alt="пример оформления содержания курсовой" width="70%" />
                    ...
                    <div className="quote">Пример: «…» [4, c.22]. Это будет значить, что цитата взята из книги, находящейся под четвертым номером в списке литературы, с 22 страницы.</div>
                    ...
                    <img src="http://217.71.129.139:4560/bibliography.png" alt="пример оформления списка литературы" width="70%" />
                    ...
                    <div className="note">Графические материалы (иллюстрации) – дополнения к текстовой части Вашей работы, состоящие из таблиц, схем, графиков, чертежей, графических изображений документов (сканов) и рисунков.</div>
